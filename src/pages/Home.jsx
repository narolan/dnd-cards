    ...
    return (
        <article>
            ...
            <section className="block">
                <p className="text">
                    This work includes material taken from the System Reference Document 5.1 (“SRD 5.1”) by Wizards of the Coast LLC and available at <a className="text" href={"https://dnd.wizards.com/resources/systems-reference-document"}>https://dnd.wizards.com/resources/systems-reference-document</a>.
                    <br/>
                    The SRD 5.1 is licensed under the Creative Commons Attribution 4.0 International License available at <a className="text" href={"https://creativecommons.org/licenses/by/4.0/legalcode"}>https://creativecommons.org/licenses/by/4.0/legalcode</a>.
                </p>
            </section>
